...
export const getCTProductById = async (
  id: string
...
export const getCTOrderById = async (id: string): Promise<Order | null> => {
  try {
...
export const setCTExternalOrderNumber = async (orderid: string, externalid: string): Promise<Order | null> => {
  try {
...
export const getCTCustomerById = async (id: string): Promise<Customer | null> => {
  try {
